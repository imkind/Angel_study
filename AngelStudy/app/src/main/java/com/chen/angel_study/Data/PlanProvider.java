...
public class PlanProvider<T> {
    private PlanDpHelper dbHelper;

    public PlanProvider() {
        dbHelper = new PlanDpHelper();
    }

    //输出一个Plan
    public T queryOne(String sql, PlanCallbackk<T> callback, String...args) {
        T t = null;
    ...
    public List<T> query(String sql, PlanCallbackk<T> callback, String... args) {
